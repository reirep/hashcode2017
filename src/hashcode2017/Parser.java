...
public class Parser {
    ...
    public static void main(String ... args){
        String in = "trending_today";
        build("res/"+in+".in");

        System.out.println("Parse of the input complete ! \n" +
                "Videos :\t"+nbreVideos+"\n" +
                "Endpoints:\t"+nbreEndpoint+"\n" +
                "Anticipated requests:\t"+nbreAnticipatedrequest+"\n" +
                "Caches:\t"+nbreCache+"\n" +
                "Cache size:\t"+tailleCache+"\n");
        for(Endpoint e  : endpoints)
            e.sendRequests();
    
        System.out.println("End of the loading of the caches.");
